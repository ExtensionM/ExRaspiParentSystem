...
var message_parser = function(){
	...
	var send_command = function(str){
		...
		console.log("[RECIVE COMMAND] id: " + command.id + " functionName: " + command.functionName);
	...
	var send_functions = function(str){
		...
		console.log("[SEND FUNCTION] id: " + functions.id + " name: " + functions.name);
		var str = JSON.stringify(obj);
		return str;
	};
	/************************************************************************/
	...
	var send_result = function(str){
		...
		console.log("[FUNCTION RESULT] id: " + result.id + " name: " + result.value.functionName);
		var str = JSON.stringify(obj);
		return str;
	};
	/*******************************************************************************/
	...
	var send_message = function(str){
		...
		console.log("[FUNCTION MESSAGE] id: "  + result.id + " name: " + result.value.functionName);
		var str = JSON.stringify(obj);
		return str;	
	};
	/*******************************************************************************/
