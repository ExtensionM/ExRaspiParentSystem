...
var message_parser = function(){
	...
	webclient_sender.on('error',function(error){console.log("ERROR")});
	webclient_sender.on('close',function(){
		webclient_sender.setTimeout(500,function(){
			console.log("WebClient Sender Reconnecting...");
	...
	children_sender.on('error',function(error){console.log("ERROR")});
	children_sender.on('close',function(error){
		children_sender.setTimeout(500,function(){
			console.log("Children Client Sedner Reconnecting....");
...
c.start();
module.export = RaspiParent.message_parser;
